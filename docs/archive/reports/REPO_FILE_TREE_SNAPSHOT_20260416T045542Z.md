...
Generated at `20260416T045542Z` from `/home/jordi/claurst`.

Excludes common generated/artifact paths to keep the snapshot useful for project context:
`.git`, `node_modules`, `target`, `dist`, `build`, `coverage`, `__pycache__`, `.DS_Store`.
