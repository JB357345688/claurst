...
> Status: historical planning evidence only / non-controlling.
>
> This file remains in `docs/Current/` only as historical planning evidence for the M11 path that has already been accepted and closed.
